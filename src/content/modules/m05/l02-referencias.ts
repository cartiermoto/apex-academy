...
System.debug(city);`,
    ...
    },
    {
      ...
      answer: 0,
      explain: {
        es: "clone() fabrica un objeto nuevo con los mismos valores. La segunda opción solo copia el enlace, y la tercera no existe.",
        en: "clone() produces a new object with the same values. The second option only copies the link, and the third does not exist.",
      },
      tags: ["recall"],
    },
    {
