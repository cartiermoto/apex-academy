...
String size = amount > 1000 ? 'Large' : 'Small';`,
    ...
    },
    {
      ...
      answer: 0,
      explain: {
        es: "Solo cambia el valor, así que basta una expresión. La segunda opción ni siquiera dejaría usar dealType después, y switch no acepta Boolean.",
        en: "Only the value changes, so an expression is enough. The second option would not even let you use dealType afterwards, and switch does not accept Boolean.",
      },
      tags: ["interleaving"],
    },
    {
